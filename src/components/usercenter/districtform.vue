<template>
    <div>
        <group title="选择所属区县" label-width="4em" label-margin-right="2em" label-align="right">
            <popup-picker required value-text-align="left" placeholder="必填" title="所属地区" show-name @on-change="distritconChange" :data="districtData"
                :columns="3" v-model="selectDistrict" ref="picker3"></popup-picker>
        </group>
        <div class="sbbtn">
